...
var grokOgIdentity = { "site": {
	"title": "TorqBoss Nesting",
	"description": "Bancada de nesting industrial — chapa, peça e ordem de corte.",
	"card": "custom",
	"image": "/og.jpg"
} };
//#endregion
...
var _lazy_gDFygc = defineLazyEventHandler(() => import("./_chunks/ssr-renderer.mjs"));
var findRoute = /* @__PURE__ */ (() => {
	const data = {
		route: "/**",
		handler: _lazy_gDFygc
	};
	return ((_m, p) => {
		return {
			data,
